...
#define  NET_CTR_CFG_STAT_EN                    DEF_DISABLED     /* Configure statistics counter feature (see Note #1) : */
                                                                /*   DEF_DISABLED     Stat  counters DISABLED           */
                                                                /*   DEF_ENABLED      Stat  counters ENABLED            */

#define  NET_CTR_CFG_ERR_EN                     DEF_DISABLED     /* Configure error      counter feature (see Note #2) : */
...
*/
                                                                ...
                                                                /* ... (see Note #1) :                                  */
#define  NET_BUF_CFG_NBR_SMALL                             2    /* 4 Configure total number of SMALL BUFFERs.             */
#define  NET_BUF_CFG_NBR_LARGE                             1    /* 2 Configure total number of LARGE BUFFERs.             */

                                                                /* Configure size of       BUFFER DATA areas ...        */
                                                                /* ... (see Note #2) :                                  */
#define  NET_BUF_CFG_DATA_SIZE_SMALL                     256    /* 256 Configure size of SMALL BUFFER DATA area.            */
#define  NET_BUF_CFG_DATA_SIZE_LARGE                    1596    /* 1596 Configure size of LARGE BUFFER DATA area.            */
...
#define  NET_ICMP_CFG_TX_SRC_QUENCH_SIZE                  5    /* Configure ICMP transmit source quench list size.     */
...
#define  NET_TCP_CFG_NBR_CONN                             1    /* Configure total number of TCP connections.           */


                                                                /* Configure TCP connections' window sizes ...          */
                                                                /* ... in integer number of octets (see Note #2) :      */

#define  NET_TCP_CFG_RX_WIN_SIZE_OCTET                  (1 * 1460u)     /* Configure TCP connection receive  window size.       */
#define  NET_TCP_CFG_TX_WIN_SIZE_OCTET                  (1 * 1460u)    /* Configure TCP connection transmit window size.       */
...
#define  NET_CONN_CFG_NBR_CONN                            4    /* Configure total number of connections (see Note #3). */
